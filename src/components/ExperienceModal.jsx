...
const ExperienceModal = ({ experienceId, userId, exp, getExps, show, handleClose}) => {
...
useEffect(()=>{
 ...
 const handleSubmit =(e) => {
  ...
  return (
    <>
    {console.log("in the model",{ experienceId, userId, exp, getExps, show, handleClose})}
